...
<body>
	...
	<div class="row">
		<div class="col-sm-6" style="left: 0.5%">
			<img src="images/index_img3.jpeg" class="img-rounded" title="talsgrad" display:block; width="100%">
			<div id="centered1" class="centered"><p style="color: white;"><span class="glyphicon glyphicon-search">&nbsp<strong></strong>Support Artificial Intelligence work.</span></p></div>
			<div id="centered2" class="centered"><p style="color: white;"><span class="glyphicon glyphicon-search">&nbsp<strong></strong>Find Tasks, comple Tasks.</span></p></div>
			<div id="centered3" class="centered"><p style="color: white;"><span class="glyphicon glyphicon-search">&nbsp<strong></strong>Get paid for your work.</span></p></div>
		</div>
							...
							<div class='modal-dialog'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										...
										<p class="glyphicon glyphicon-star">  The contractors who want to have a portfolio to share on the go.</p><br>
										...
										<center><a href="signup.php" style="color: #fd4720;"> SIGN-UP TO FIND OUT MORE...THANK YOU!</a></center>
		...
		<div class="col-sm-5">
			<img src="images/capture.png" class="img-rounded" title="talsgrad" display:block; width="70%"><a href="#"><button type='button' class='btn btn-default' data-toggle='modal' data-target='#myModal' style="background-color: #fd4720; color: white;">Find Out More!</button></a>
			<center><h2 style="margin-bottom: 0px;"><strong>Find the tasks that suit</strong></h2></center>
			<center><h2 style="margin-top: 0px;"><strong>you and get paid for completing them.</strong></h2></center>
			<div>
				<center><img src="images/happy.svg" class="img-circle" title="happy" display:block; width="30%"></center>
				<center><p style="color: #232746"><strong>Inspire and be inspired by paid remote work!</strong></p></center>
			</div>
			<div style="height: 5px;"></div>
			<center><h4><strong>Sign Up to create your free portfolio account.</strong></h4></center>
			<center>
