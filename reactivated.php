...
<html>
<head>
	<title>Reactivation Success. Welcome back to Mechsupport: Find tasks, complete tasks, get paid.</title>
	<meta charset="utf-8">
						...
						if(isset($_SESSION['user_email'])){
							...
							if(isset($_GET['u5Nm'])){
								...
								if ($u_name == $user_name) { // don't show the deactivation link if it's not the same user!
									...
									$update = "UPDATE users SET active = 'yes' WHERE user_name='$u_name'";
									$run_update = mysqli_query($con, $update);

									if($run_update){

										echo "<div class='statusmsg'>Your account has been reactivated, you can now <a href='signin.php' style='color:#fd4720;'>login</a></div>";
