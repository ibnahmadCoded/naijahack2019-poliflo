	...
	<?php 
		...
		else
		{
			echo "
				...
				<div class='row'>
					<button class='btn btn-info' style='float: left; width: 120px; height: 50px; margin: 30px; margin-left: 100px;'><a href='next_media.php?media_file=$next_media&question=$task_question&path=$path&task_id=$task_id' style='color: black;'>BACK TO TASK</a></button><br>
