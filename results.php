...
<html>
<head>
	<title>Search Results on Mechsupport. Find tasks on Mechsupport.</title>
	<meta charset="utf-8">
...
<body>
	...
	global $con;
		...
		$get_tasks = "SELECT * FROM tasks WHERE title like '%$search_query%' AND cost > 0 AND pay_received='yes' AND submitted != 'yes' AND attached_users = 0 OR type like '%$search_query%' AND cost > 0 AND pay_received='yes' AND submitted != 'yes' AND attached_users = 0 ORDER BY id DESC";
